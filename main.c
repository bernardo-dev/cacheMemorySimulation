...
int main(int argc, char **argv) {
  ...
  if (argc != 6) {
    ...
    printf("Linha de execucao: ./exe TIPO_INSTRUCAO "
           "[TAMANHO_RAM|ARQUIVO_DE_INSTRUCOES] TAMANHO_L1 TAMANHO_L2 "
           "TAMANHO_L3\n");
    printf("\tExemplo 1 de execucao: ./exe random 10 2 4 8\n");
    printf(
        "\tExemplo 2 de execucao: ./exe file arquivo_de_instrucoes.txt 2 4\n");
    return 0;
  }
